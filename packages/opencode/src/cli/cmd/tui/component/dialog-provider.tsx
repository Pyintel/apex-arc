...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@pyintel/sdk/v2"
      ...
      description={
        {
          ...
          "opencode-go": (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://opencode.ai/zen</span> and enable Arc Go
              </text>
            </box>
          ),

...
export const FREE_MODEL_IDS = new Set(["arc-auto", "arc-free"])

const TERMS_URL = "https://platform.pyintelarc.com/docs/terms/user-agreement"
const PRIVACY_URL = "https://privacy.mi.com/PyintelArcPlatform"

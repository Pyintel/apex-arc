export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using ARC, you agree to our ",
  ...
  "tui.tips.share": "Run {highlight}/share{/highlight} to create a public link to your conversation at apex.pyintel.cc/arc",
  ...
  "tui.tips.config_files":
    "Create {highlight}arc.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/apex-arc/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "ARC auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.arc/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.arc/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "ARC auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "ARC uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.arc/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.arc/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent ARC from reading sensitive files",
  "tui.tips.run": "Use {highlight}apex-arc run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}apex-arc --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}apex-arc run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}arc serve{/highlight} for headless API access to ARC",
  "tui.tips.attach_server": "Use {highlight}apex-arc run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}arc upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}arc auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}arc agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/arc{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}arc github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.arc/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}arc debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.docker": "Run {highlight}docker run -it --rm ghcr.io/anomalyco/arc{/highlight} for containerized use",
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with ARC for curated, tested models",
  ...
  "tui.model.arc_auto.name": "Arc Auto (Arc-V2.5, limited-time free)",
  ...
  "tui.toast.update_available.success": "Successfully updated to ARC v{{version}}. Please restart the application.",
  ...
  "tui.voice.error.no_auth": "Use /connect to sign in to Arc, or configure voice.asr_model for another provider",
  ...
  "tui.dialog.login.pyintel": "Pyintel",
  "tui.dialog.login.pyintel.desc": "(Recommended)",
  "tui.dialog.login.arc_free": "Arc Auto (free)",
  "tui.dialog.login.arc_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.arc_free.success": "Arc Auto (free) is ready — default model set to arc/arc-auto",
  "tui.dialog.login.arc_free.unavailable": "Arc Auto (free) provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.arc.recommended_hint": "recommended",
  "cli.providers.arc_free.hint": "Anonymous free channel / arc-auto",
  "cli.providers.arc_free.verifying": "Verifying Arc Auto (free) channel...",
  "cli.providers.arc_free.ready": "Arc Auto (free) channel ready",
  "cli.providers.arc_free.failed": "Arc Auto (free) verification failed",
  "cli.providers.arc_free.default_set": "Default model set to arc/arc-auto (1M context, free)",
  "cli.providers.arc_free.usage_hint": "No login required — just run arc. For paid/premium models, choose Arc browser login instead.",
  "cli.providers.arc_login.decrypt_retry": "Decryption failed, please retry ({remaining} attempts left)",
  "cli.providers.arc_login.decrypt_exhausted": "Decryption failed, max retries reached",
  ...
  "tui.dialog.login.flow.title": "Arc Login",
  ...
  "trust.capabilities": "ARC will be able to read, edit, and execute files here.",

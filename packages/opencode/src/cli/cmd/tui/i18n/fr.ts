...
export const dict = {
  ...
  "tui.home.agreement.prefix": "En utilisant ARC, vous acceptez nos ",
  ...
  "tui.tips.share":
    "Exécutez {highlight}/share{/highlight} pour créer un lien public vers votre conversation sur apex.pyintel.cc/arc",
  ...
  "tui.tips.config_files":
    "Créez {highlight}arc.json{/highlight} pour la configuration serveur et {highlight}tui.json{/highlight} pour le TUI",
  "tui.tips.global_config":
    "Placez les paramètres TUI dans {highlight}~/.config/apex-arc/tui.json{/highlight} comme configuration globale",
  ...
  "tui.tips.mcp_oauth":
    "ARC gère automatiquement OAuth pour les serveurs MCP distants nécessitant une authentification",
  "tui.tips.custom_command":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.arc/command/{/highlight} pour définir des invites personnalisées réutilisables",
  ...
  "tui.tips.custom_agent":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.arc/agent/{/highlight} pour des personas IA spécialisés",
  ...
  "tui.tips.formatter": "ARC formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.tips.lsp": "ARC utilise des serveurs LSP pour une analyse de code intelligente",
  "tui.tips.custom_tool":
    "Créez des fichiers {highlight}.ts{/highlight} dans {highlight}.arc/tools/{/highlight} pour définir de nouveaux outils LLM",
  "tui.tips.tool_scripts": "Les définitions d'outils peuvent invoquer des scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Ajoutez des fichiers {highlight}.ts{/highlight} dans {highlight}.arc/plugin/{/highlight} pour des hooks d'événements",
  ...
  "tui.tips.plugin_protect":
    "Créez un plugin pour empêcher ARC de lire des fichiers sensibles",
  "tui.tips.run": "Utilisez {highlight}apex-arc run{/highlight} pour des scripts non interactifs",
  "tui.tips.continue": "Utilisez {highlight}apex-arc --continue{/highlight} pour reprendre la dernière session",
  "tui.tips.attach_cli":
    "Utilisez {highlight}apex-arc run -f file.ts{/highlight} pour joindre des fichiers via la CLI",
  "tui.tips.format_json":
    "Utilisez {highlight}--format json{/highlight} pour une sortie lisible par machine dans les scripts",
  "tui.tips.serve": "Exécutez {highlight}apex-arc serve{/highlight} pour exposer l'API ARC en mode headless",
  "tui.tips.attach_server":
    "Utilisez {highlight}apex-arc run --attach{/highlight} pour vous connecter à un serveur en cours",
  "tui.tips.upgrade": "Exécutez {highlight}apex-arc upgrade{/highlight} pour passer à la dernière version",
  "tui.tips.auth_list":
    "Exécutez {highlight}apex-arc auth list{/highlight} pour voir tous les fournisseurs configurés",
  ...
  "tui.tips.theme_files":
    "Créez des fichiers de thème JSON dans le dossier {highlight}.arc/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Exécutez {highlight}apex-arc debug config{/highlight} pour diagnostiquer la configuration",
  "tui.tips.print_logs":
  ...
  "tui.model.apex-arc_auto.name": "Arc Auto (Arc-V2.5, gratuit pour une durée limitée)",
  ...
  "tui.toast.update_available.success": "Mis à jour vers ARC v{{version}}. Veuillez redémarrer l'application.",
  ...
  "tui.voice.error.no_auth": "Utilisez /connect pour vous connecter à Arc, ou configurez voice.asr_model pour un autre fournisseur",
  ...
  "tui.dialog.login.apex-arc_free.desc": "Canal anonyme gratuit — aucune connexion requise",
  "tui.dialog.login.apex-arc_free.success": "Arc Auto (free) est prêt — modèle par défaut défini sur apex-arc/apex-arc-auto",
  "tui.dialog.login.apex-arc_free.unavailable": "Fournisseur Arc Auto (free) non chargé",
  "tui.dialog.login.flow.title": "Connexion Arc",
  ...
  "cli.providers.apex-arc.recommended_hint": "recommandé",
  "cli.providers.apex-arc_free.hint": "Canal anonyme gratuit / apex-arc-auto",
  "cli.providers.apex-arc_free.verifying": "Vérification du canal Arc Auto (free)...",
  "cli.providers.apex-arc_free.ready": "Canal Arc Auto (free) prêt",
  "cli.providers.apex-arc_free.failed": "Échec de la vérification de Arc Auto (free)",
  "cli.providers.apex-arc_free.default_set": "Modèle par défaut défini sur apex-arc/apex-arc-auto (contexte 1M, gratuit)",
  "cli.providers.apex-arc_free.usage_hint":
    "Aucune connexion requise — exécutez simplement apex-arc. Pour les modèles payants/premium, choisissez plutôt la connexion navigateur Arc.",
  "cli.providers.apex-arc_login.decrypt_retry": "Échec du déchiffrement, veuillez réessayer ({remaining} tentatives restantes)",
  "cli.providers.apex-arc_login.decrypt_exhausted": "Échec du déchiffrement, nombre maximal de tentatives atteint",
  ...
  "trust.capabilities": "ARC pourra lire, modifier et exécuter des fichiers ici.",

...
export const dict = {
  ...
  "tui.model.apex-arc_auto.name": "MiMo Auto (MiMo-V2.5, gratuit pour une durée limitée)",
  ...
  "tui.dialog.login.apex-arc_free.success": "MiMo Auto (free) est prêt — modèle par défaut défini sur apex-arc/apex-arc-auto",
  "tui.dialog.login.apex-arc_free.unavailable": "Fournisseur MiMo Auto (free) non chargé",
  ...
  "cli.providers.apex-arc_free.verifying": "Vérification du canal MiMo Auto (free)...",
  "cli.providers.apex-arc_free.ready": "Canal MiMo Auto (free) prêt",
  "cli.providers.apex-arc_free.failed": "Échec de la vérification de MiMo Auto (free)",
  ...
  "cli.providers.apex-arc_free.usage_hint":
    "Aucune connexion requise — exécutez simplement apex-arc. Pour les modèles payants/premium, choisissez plutôt la connexion navigateur MiMo.",

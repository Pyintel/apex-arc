...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Al usar ARC, aceptas nuestros ",
  ...
  "tui.tips.share":
    "Ejecuta {highlight}/share{/highlight} para crear un enlace público a tu conversación en apex.pyintel.cc/arc",
  ...
  "tui.tips.config_files":
    "Crea {highlight}arc.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/apex-arc/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "ARC gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.arc/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.arc/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.formatter": "ARC formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "ARC usa servidores LSP para análisis inteligente de código",
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.arc/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.arc/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a ARC leer archivos sensibles",
  "tui.tips.run":
    "Usa {highlight}apex-arc run{/highlight} para scripting no interactivo",
  "tui.tips.continue":
    "Usa {highlight}apex-arc --continue{/highlight} para retomar la última sesión",
  "tui.tips.attach_cli":
    "Usa {highlight}apex-arc run -f file.ts{/highlight} para adjuntar archivos vía CLI",
  "tui.tips.format_json":
    "Usa {highlight}--format json{/highlight} para obtener salida legible por máquina en scripts",
  "tui.tips.serve":
    "Ejecuta {highlight}apex-arc serve{/highlight} para acceso headless a la API de ARC",
  "tui.tips.attach_server":
    "Usa {highlight}apex-arc run --attach{/highlight} para conectarte a un servidor en ejecución",
  "tui.tips.upgrade":
    "Ejecuta {highlight}apex-arc upgrade{/highlight} para actualizar a la última versión",
  "tui.tips.auth_list":
    "Ejecuta {highlight}apex-arc auth list{/highlight} para ver todos los proveedores configurados",
  "tui.tips.agent_create":
    "Ejecuta {highlight}apex-arc agent create{/highlight} para crear un agente con asistente guiado",
  "tui.tips.github_trigger":
    "Usa {highlight}/arc{/highlight} en issues/PR de GitHub para disparar acciones de IA",
  "tui.tips.github_install":
    "Ejecuta {highlight}apex-arc github install{/highlight} para configurar el workflow de GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.arc/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Ejecuta {highlight}apex-arc debug config{/highlight} para diagnosticar problemas de configuración",
  "tui.tips.print_logs":
  ...
  "tui.tips.docker":
    "Ejecuta {highlight}docker run -it --rm ghcr.io/anomalyco/arc{/highlight} para uso en contenedor",
  "tui.tips.zen":
    "Usa {highlight}/connect{/highlight} con ARC para modelos seleccionados y probados",
  "tui.tips.agents_md":
  ...
  "tui.model.apex-arc_auto.name": "Arc Auto (Arc-V2.5, gratis por tiempo limitado)",
  ...
  "tui.toast.update_available.success": "Se actualizó a ARC v{{version}}. Por favor reinicie la aplicación.",
  ...
  "tui.voice.error.no_auth": "Usa /connect para conectar tu cuenta Arc, o configura voice.asr_model para otro proveedor",
  ...
  "trust.capabilities": "ARC podrá leer, editar y ejecutar archivos aquí.",
  ...
  "tui.dialog.login.flow.title": "Inicio de sesión Arc",

...
export const dict = {
  ...
  "tui.tips.serve": "运行 {highlight}mimo serve{/highlight} 以无头模式提供 ARC API",
  ...
  "cli.providers.mimo_free.usage_hint": "无需登录，直接 apex-arc run 即可使用。如需付费/更高级模型，可重新选择 MiMo 浏览器登录。",

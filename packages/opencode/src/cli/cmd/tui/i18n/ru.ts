...
export const dict = {
  ...
  "tui.model.apex-arc_auto.name": "MiMo Auto (MiMo-V2.5, временно бесплатно)",
  ...
  "tui.dialog.login.apex-arc_free": "MiMo Auto (free)",
  "tui.dialog.login.apex-arc_free.desc": "Анонимный бесплатный канал — вход не требуется",
  "tui.dialog.login.apex-arc_free.success": "MiMo Auto (free) готов — модель по умолчанию: apex-arc/apex-arc-auto",
  "tui.dialog.login.apex-arc_free.unavailable": "Провайдер MiMo Auto (free) не загружен",
  ...
  "cli.providers.apex-arc_free.verifying": "Проверка канала MiMo Auto (free)...",
  "cli.providers.apex-arc_free.ready": "Канал MiMo Auto (free) готов",
  "cli.providers.apex-arc_free.failed": "Не удалось проверить MiMo Auto (free)",
  ...
  "cli.providers.apex-arc_free.usage_hint":
    "Вход не требуется — просто запустите apex-arc. Для платных/премиум-моделей выберите вход через браузер MiMo.",

...
export const OUTPUT_TOKEN_MAX = Flag.ARC_EXPERIMENTAL_OUTPUT_TOKEN_MAX || 32_000
...
function limitImages(msgs: ModelMessage[]): ModelMessage[] {
  const maxImages = Flag.ARC_MAX_PROMPT_IMAGES
  const maxSize = Flag.ARC_MAX_PROMPT_IMAGE_SIZE

...
export function createTextNgramMonitor() {
  return new TextNgramMonitor(
    Flag.ARC_TEXT_NGRAM_N,
    Flag.ARC_TEXT_REPEAT_THRESHOLD,
    Flag.ARC_TEXT_WINDOW_TOKENS,
  )
}
...
REPETITION DETECTED: Your recent output contains repeated phrases (sliding n-gram match within your last ${Flag.ARC_TEXT_WINDOW_TOKENS} tokens).

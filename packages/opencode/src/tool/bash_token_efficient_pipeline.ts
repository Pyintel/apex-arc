...
const MAX_LINE_CHARS = Flag.ARC_EXPERIMENTAL_TOKEN_EFFICIENCY_MAX_LINE_CHARS
const LINE_HEAD_KEEP = Flag.ARC_EXPERIMENTAL_TOKEN_EFFICIENCY_LINE_HEAD_KEEP
const NEVER_WORSE_MARGIN = Flag.ARC_EXPERIMENTAL_TOKEN_EFFICIENCY_NEVER_WORSE_MARGIN

...
const DEFAULT_TIMEOUT = Flag.ARC_EXPERIMENTAL_BASH_DEFAULT_TIMEOUT_MS || 2 * 60 * 1000
...
export const BashTool = Tool.define(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("BashTool.run")(function* (
      ...
      const cleaned =
        !file && Flag.ARC_EXPERIMENTAL_TOKEN_EFFICIENCY
      ...
      const heuristic =
        !file &&
        Flag.ARC_EXPERIMENTAL_TOKEN_EFFICIENCY &&
        Flag.ARC_EXPERIMENTAL_TOKEN_EFFICIENCY_HEURISTIC

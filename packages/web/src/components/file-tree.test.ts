...
beforeAll(async () => {
  ...
  mock.module("@pyintel/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@pyintel/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@pyintel/ui/icon", () => ({ Icon: () => null }))
  mock.module("@pyintel/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

...
const releaseId = process.env.ARC_RELEASE
if (!releaseId) throw new Error("ARC_RELEASE is required")

const version = process.env.ARC_VERSION
if (!version) throw new Error("ARC_VERSION is required")

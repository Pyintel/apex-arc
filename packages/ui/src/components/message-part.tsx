...
import { getDirectory as _getDirectory, getFilename } from "@pyintel/shared/util/path"
...
ToolRegistry.register({
  ...
  render(props) {
    const i18n = useI18n()
    const questions = createMemo(() => (props.input.questions ?? []) as QuestionInfo["questions"])
